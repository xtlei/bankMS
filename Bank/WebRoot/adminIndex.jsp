<%@page import="cn.bank.entity.Administrator"%>
...
<link href="res/font/font-awesome.min.css" rel="stylesheet"  type="text/css" />
  ...
  <body style="overflow:hidden">
   <%
		Administrator admin = (Administrator)session.getAttribute("current_user");
  %>
...
<header class="Hui-header cl"> 
   ...
   <span class="Hui-userbox">
      <span class="c-white">当前用户：<%=admin.getAdminName()%></span> 
...
<div class="cl Hui-main">
  <aside class="Hui-aside" style="">
    ...
    <div class="menu_dropdown bk_2">
      <dl id="menu-user">
        <dt><a _href="BaseServlet?p=1">
        <i class="icon-user"></i> 增加用户<b></b></a></dt>
      </dl>
      <dl id="menu-comments">
        <dt><a _href="SumMoneyServlet?p=1" href="javascript:;">
        <i class="icon-comments"></i> 查询储蓄总额<b></b></a></dt>
      </dl>
      <dl id="menu-product">
