  ...
  <body>
    <div class="pd-20">
  	<table class="table table-border table-bordered table-bg">
      	<thead>
        <tr>
          <th colspan="2"><font size='4'>计算银行储蓄总额</font></th>
        </tr>
      </thead>
    <tbody>
    <%
	...
	%>
         ...
         <tr>
            <th width="200" class="text-r"><span class="c-red">*</span><font size='3'> 当前银行储蓄总额为：</font></th>
            <td width="300"><font size='3'><%=sumMoney %></font></td>
         </tr>
